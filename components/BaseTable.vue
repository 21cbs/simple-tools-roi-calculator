    ...
    <div class="shadow-md rounded-lg mx-auto w-full">
      <div class="flex justify-end mb-6 space-x-4">
        <div class="relative">
          <button
            type="button"
            class="z-10 px-4 py-2 font-medium text-center text-black bg-dark-medium-blue border-medium-blue rounded-lg space-x-2"
          ...
          <div
            v-if="kd.visible"
            class="absolute top-full left-0 mt-2 bg-dark-medium-blue rounded-lg shadow-lg py-2 z-20 w-full"
          >
            <div
            ...
            <div class="px-2 py-1.5 space-y-2">
              <span class="text-black">Custom Range</span>
              <input
                v-model="kd.min"
                type="number"
                class="w-full rounded-lg bg-dark-medium-blue px-4 py-2 text-sm text-black focus:outline-none"
                placeholder="From"
              />
              <input
                v-model="kd.max"
              ...
              />
              <button
                class="w-full py-1.5 items-center justify-center rounded-lg bg-black text-sm font-medium text-xgrey shadow-button-primary transition-all duration-100 hover:bg-orangeHover active:bg-orange"
        ...
        <div class="flex relative">
          <button
            type="button"
            class="z-10 px-4 py-2 font-medium text-center text-xgrey bg-dark-medium-blue border-medium-blue rounded-lg space-x-2"
        ...
        <a
          type="button"
          class="flex w-full min-w-max flex-row items-center justify-center space-x-2 rounded-lg bg-medium-blue py-2 px-3 text-sm font-semibold text-black shadow-button-secondary transition-all duration-100 hover:bg-medium-blueHover active:bg-medium-blue sm:w-fit sm:px-5 sm:text-base cursor-pointer"
      ...
      <table class="min-w-full bg-medium-blue rounded-lg overflow-hidden">
        <thead>
          <tr>
            <th class="py-4 px-4 text-medium bg-dark-medium-blue text-black text-left">Keyword</th>
            <th class="py-4 px-8 text-medium bg-dark-medium-blue text-black text-center">Volume</th>
            <th class="py-4 px-8 text-medium bg-dark-medium-blue text-black text-center">KD</th>
            <th class="py-4 px-8 text-medium bg-dark-medium-blue text-black text-center">CPC</th>
            <th class="py-4 px-8 text-medium bg-dark-medium-blue text-black text-center">
              Optimize ROI
            </th>
          </tr>
        </thead>
        <tbody>
          ...
          >
            <td
              class="py-4 px-4 text-medium text-black text-left break-words whitespace-normal max-w-xs overflow-auto"
            >
              <a class="underline" :href="item.url" target="_blank">{{ item.keyword }}</a>
            </td>
            <td class="py-4 px-8 text-medium text-black text-center">
              {{ item.volume }}
            </td>
            <td class="py-4 px-8 text-medium text-black text-center">
              {{ item.kd }}
